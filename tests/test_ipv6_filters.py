...
class IPTests(unittest.TestCase):
    ...
    def test_ipv6_first_address(self):
        ...
        self.assertEqual(ip_filters.first_address('2001:db8::100/120'), "2001:db8::101/120") # wrong?
    ...
    def test_ipv6_last_address(self):
        ...
        self.assertEqual(ip_filters.last_address('2001:db8::100/120'), "2001:db8::1ff/120")
    ...
    def test_ipv6_compress(self):
        self.assertEqual(ip_filters.compress('2001:0db8:0000:0000:0000:0000:0000:0001/127'), "2001:db8::1")

    def test_ipv6_uncompress(self):
        self.assertEqual(ip_filters.uncompress('2001:db8::1'), "2001:0db8:0000:0000:0000:0000:0000:0001")

    def test_ipv6_hextets(self):
        self.assertEqual(ip_filters.hextets('2001:db8::1'), ["2001", "0db8", "0000", "0000", "0000", "0000", "0000" , "0001"])
